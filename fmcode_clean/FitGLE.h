...
public:
    ...
    std::vector<double> parallelVelocity(int step, int i, int j);
    std::vector<double> parallelUnitVector(int step, int i, int j);
    std::vector<double> paraVerticalVelocity(int step, int i, int j);
